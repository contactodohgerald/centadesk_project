                    ...
                    <tr>
                        <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <h4 style="font-family: sans-serif; font-size: 18px; font-weight: normal; margin: 0; margin-bottom: 15px; text-align: center; color:#800080;">Successful Enrollment into {{$investmentPlan->investment_title}} in {{ucwords($siteDetails->site_name)}}</h4>
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">You have successfully registered for {{$investmentPlan->investment_title}} package.</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">This package runs for a period of {{round($investmentPlan->duration_in_days)}} days</p>
                                        <hr>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">You are entitled to the following at the expiration of the no of days started above</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">The number of days stated above is reduced by three whenever you successfully refer some one to join this package with your Referral Unique ID</p>
                                        @if(count($investmentPlan->rewardsDetails) > 0)
                                            @foreach($investmentPlan->rewardsDetails as $k => $eachRewardsDetails)
                                                @php if($eachRewardsDetails->reward_type === 'cash'){
                                                    ...
                                                    $reward = 'You will earn ('.$currency.') '.$amount.' after '.round($investmentPlan->duration_in_days).' days';
                                                } else{
