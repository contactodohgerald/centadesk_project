...
<head>
    ...
    <title>Complete Dispensation of Rewards for  {{$investmentPlan->investment_title}} </title>
    <style>
                    ...
                    <tr>
                        <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <h4 style="font-family: sans-serif; font-size: 18px; font-weight: normal; margin: 0; margin-bottom: 15px; text-align: center; color:#800080;">Report on Reward Dispensation {{$investmentPlan->investment_title}} </h4>
                                ...
                                <tr>
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">This is to inform you that the period for {{$investmentPlan->investment_title}} package, which you enrolled in with {{$siteDetails->site_name}} have come to an end.</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">This package was on for a period of {{round($investmentPlan->duration_in_days)}} days</p>
                                        <hr>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Your Reward have been fully dispensed to you as we can confirm from our records.</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">The Rewards Dispensed are Listed Below: </p>
                                        @if(count($investmentPlan->rewardsDetails) > 0)
                                            @foreach($investmentPlan->rewardsDetails as $k => $eachRewardsDetails)
                                                @php if($eachRewardsDetails->reward_type === 'cash'){
                                                    $amount = number_format(round($eachRewardsDetails->amount * auth()->user()->currency_details->rate_of_conversion), 2);
                                                    $currency = auth()->user()->currency_details->second_currency;
                                                    $reward = '('.$currency.') '.$amount.' have been Paid into your'.$siteDetails->site_name.' wallet';
                                                } else{
