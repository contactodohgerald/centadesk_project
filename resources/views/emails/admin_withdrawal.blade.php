                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">{{$transactionDetails->user_details->name}} have successfully Placed a withdrawal request from his wallet on {{ucwords($siteDetails->site_name)}}.</p>
                                        ...
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">List of Pending Withdrawal Requests: </p>
                                        <hr>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                                            Please note that this request needs authorization from the Super-Admin before money will be sent to users bank account. Visit the withdrawal section of your website for more details.
                                        </p>
