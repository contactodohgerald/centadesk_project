                        ...
                        <td class="wrapper" style="font-family: sans-serif; font-size: 14px; vertical-align: top; box-sizing: border-box; padding: 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Hi {{$referrerInvestmentDetails->UserDetails->name}},</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">You have successfully referred {{$referredInvestmentDetails->UserDetails->name}} to join our {{$referredInvestmentDetails->InvestmentPlan->investment_title}} package.</p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">Adjustments have been made to {{$referrerInvestmentDetails->InvestmentPlan->investment_title}} package as follows: </p>
                                        <hr>
                                        @php $referralDetail = $referrerInvestmentDetails->SingleReferralDetails($referrerInvestmentDetails->referral_id, $referredInvestmentDetails->user_unique_id) @endphp

                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><strong>No. of Days Remaining Before Deduction : </strong><span> {{round($referralDetail->no_of_days_deducted + $referrerInvestmentDetails->time_remaining_in_days)}} Days</span></p>

                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><strong>No. of Days Deducted : </strong><span> {{round($referralDetail->no_of_days_deducted)}} Days</span></p>
                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><strong>No. of Days Remaining After Deduction : </strong><span> {{round($referrerInvestmentDetails->time_remaining_in_days)}} Days</span></p>
