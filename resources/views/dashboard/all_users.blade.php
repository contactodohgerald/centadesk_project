                                        ...
                                        <table class="table ucp-table">
                                            <thead class="thead-s">
                                                <tr>
                                                    ...
                                                    <th class="text-center" scope="col">Instructor's Balance ({{auth()->user()->getBalanceForView()['data']['currency']}})</th>
                                                    <th class="text-center" scope="col">Status</th>
                                                    <th class="text-center" scope="col">Verification Badge</th>
                                                    <th class="text-center" scope="col">Action</th>
                                                </tr>
                                        ...
                                        <table class="table ucp-table">
                                            <thead class="thead-s">
                                                <tr>
													...
													@endif
                                                    <th class="text-center" scope="col">Student's Name</th>
                                                    <th class="text-center" scope="col">Student's Email</th>
                                                    <th class="text-center" scope="col">Student's Balance ({{auth()->user()->getBalanceForView()['data']['currency']}})</th>
                                                    <th class="text-center" scope="col">Status</th>
                                                    <th class="text-center" scope="col">Verification Badge</th>
                                                    <th class="text-center" scope="col">Action</th>
                                                </tr>
                                        ...
                                        <table class="table ucp-table">
                                            <thead class="thead-s">
                                                <tr>
													...
													@endif
                                                    <th class="text-center" scope="col">The Admin's Name</th>
                                                    <th class="text-center" scope="col">Admin's Email</th>
                                                    <th class="text-center" scope="col">Admin's Balance ({{auth()->user()->getBalanceForView()['data']['currency']}})</th>
                                                    <th class="text-center" scope="col">Status</th>
                                                    <th class="text-center" scope="col">Verification Badge</th>
                                                    <th class="text-center" scope="col">Action</th>
                                                </tr>
                ...
                <div class="modal-content">
                    ...
                    <form class="delete_course_form">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class=" night-text text-danger">By clicking continue, this User will be deleted permanently. <br> Every course & live stream created by this user will also be deleted.</h4>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.delete_course_btn').click(async function(e) {
                    ...
                    let returned = await ajaxRequest('/delete_user/' + data[1].value, form_data);
                    // return;
                    validator(returned, '/all_users');
                });
