        ...
        <div class="sa4d25">
            <div class="container-fluid">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-account" role="tabpanel" aria-labelledby="pills-account-tab">
                                ...
                                <div class="account_setting">
                                    ...
                                    <p>This is your public presence on CentaDesk. You need a account to upload your paid courses, comment on courses, purchased by students, or earning.</p>
                                                    ...
                                                    <div class="row mt-30">
                                                        <div class="col-lg-3">
                                                            <div style="width: 100%;" class="view_img_left">
                                                                <div class="view__img">
                                                                    <img id="thumbnail_cover_img" class="round_img" src="/storage/profile/{{ $user->profile_image }}">
                                                                </div>
                                                            </div>
                                                        </div>
                ...
                <div class="account_setting">
                    ...
                    <button class="save_btn update_profile_btn col-lg-4 float-right" type="submit">Save Changes</button>
                </div>
            </div>
            <div class="tab-pane fade" id="pills-bank-account" role="tabpanel" aria-labelledby="pills-bank-account-tab">
                <div class="account_setting">
                    <form action="{{route('update_bank_account' )}}" method="POST">
                        ...
                        <button class="save_btn col-lg-4 float-right" type="submit">Save Changes</button>
                    </form>
                </div>
            </div>
