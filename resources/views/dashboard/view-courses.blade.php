@php $users = auth()->user(); $pageTitle = 'View Courses'; $Course = 'active';
@endphp @include('layouts.head')
                            ...
                            >
                                ...
                                <li class="nav-item">
                                    <a
                                        ...
                                        aria-selected="false"
                                        ><i class="uil uil-download-alt"></i>My
                                        Purchases</a
                                    >
                                </li>
                                <li class="nav-item">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <button
                            ...
                            class="close"
                            data-dismiss="modal"
                            onclick="removeModalMains('.delete_course_modal')"
                        >
                            &times;
                        </button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="text-dark night-text">
                                        By clicking continue, this course will
                                        be deleted permanently. <br />
                                        It can't be recovered after this.
                                    </h4>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <button
                            ...
                            class="close"
                            data-dismiss="modal"
                            onclick="removeModalMains('.set_bestseller_modal')"
                        >
                            &times;
                        </button>
                    </div>
                    ...
                    <form class="set_bestseller_form">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="text-dark night-text">
                                        By clicking continue, the bestseller
                                        status of this course will change!
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button class="btn btn-primary set_bestseller_btn">
                            Proceed
                        </button>
                    </div>
                </div>
            ...
            $(document).ready(function () {
                ...
                $(".set_bestseller_btn").click(async function (e) {
                    ...
                    let returned = await ajaxRequest(
                        "/bestseller/" + set_bestseller_form[1].value,
                        form_data
                    );
                ...
                $(".delete_course_btn").click(async function (e) {
                    ...
                    let returned = await ajaxRequest(
                        "/delete-course/" + delete_course_form[1].value,
                        form_data
                    );
                    // return;
                    validator(returned, "/view-courses");
