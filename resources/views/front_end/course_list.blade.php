       ...
       <div class="container">
           <div class="yl-course-top">
               <div class="row">
                   <div class="col-lg-12">
                       <div class="yl-section-title yl-headline">
                           <h2>All  {{ ucfirst($course_category->name) }} Courses</h2>
                       </div>
                   </div>
           ...
           <div class="yl-course-filter-wrap">
               ...
               <div class="filtr-container-area grid clearfix">
                   ...
                   @if(count($course_category->courses) > 0)
               ...
               <div class="yl-course-pagination clearfix text-center ul-li mt-5">
                   <ul>
                       <li>
                           <a href="{{$course_category->courses->nextPageUrl()}}">Nxt</a>
                           <a href="#">{{$course_category->courses->currentPage()}}</a>
                           <a href="{{$course_category->courses->previousPageUrl()}}">Prv</a>
                       </li>
                   </ul>
               </div>
